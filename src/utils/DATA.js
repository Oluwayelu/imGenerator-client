export const faqs = [
  {
    id: 0,
    question: "What exactly is imGenerator and how does it work?",
    answer:
      "ImGenerator is an AI-powered platform that generates images based on your creative inputs. It uses advanced algorithms to learn from a diverse range of images and then generates new visuals that match your artistic intent. Simply provide a description, concept, or rough sketch, and let our AI transform your ideas into stunning images.",
  },
  {
    id: 1,
    question: "How can I use the images generated on imGenerator?",
    answer:
      "The generated images are yours to use as you wish. Download them and incorporate them into your projects, whether it's designing websites, creating marketing materials, or adding visuals to your personal artwork. ImGenerator seamlessly integrates with your creative workflow, enhancing your projects with AI-generated visuals.",
  },
  {
    id: 2,
    question:
      "Is imGenerator suitable for both beginners and experienced designers?",
    answer:
      "Absolutely! ImGenerator's user-friendly interface makes it accessible to all skill levels. Whether you're a seasoned designer or a beginner exploring the world of art, our platform is designed to accommodate everyone. No coding or AI expertise is required; all you need is your imagination.",
  },
  {
    id: 3,
    question: "Can I collaborate with others on imGenerator?",
    answer:
      "Absolutely! ImGenerator encourages collaboration and creativity. You can share your generated images with others. Our platform fosters a community of creators who are eager to explore the potential of AI-generated visuals together.",
  },
  {
    id: 4,
    question: "Are the images generated by imGenerator royalty-free?",
    answer:
      "Yes, indeed. The images you generate using imGenerator are royalty-free. You have full ownership and rights to use these images in your personal and commercial projects without any attribution. ImGenerator empowers you to enhance your creative projects without worrying about licensing issues.",
  },
];
